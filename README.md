...
org	0x7c00
	...
	mov	bx, [ds:1Ch]		;offset of program header table
loop:
	mov	cx, word [ds:(bx+10h)]	;size = size32 & 0xFFFF
	mov	di, word [ds:(bx+8h)]	;dst = dst32 & 0xFFFF
	mov	si, [ds:(bx+4h)]	;src = src32 & 0xFFFF
...
LABEL_GDT_FLAT_RW:	Descriptor	0, 0FFFFFh, DA_DRW + DA_32 + DA_LIMIT_4K
