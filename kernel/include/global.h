...
extern_flag kb_input_t          g_kb_in;
...
/* memory */
extern_flag u32_t               g_page_directory_base;
extern_flag pde_t*              g_pdt;
extern_flag u32_t               g_page_table_base;
extern_flag u32_t               g_page_table_count;

extern u8_t                     g_keymap[]; 
